...
def generate_story(age_group, story_tone, moral_theme, language, characters):
    prompt = ChatPromptTemplate.from_messages([
        SystemMessage(content="You are a creative story writer generating unique stories for children."),
        HumanMessage(content=f"Generate a story for {age_group} with characters {characters}, {story_tone} tone, theme {moral_theme}, in {language}, include title, simple and engaging.")
    ])
